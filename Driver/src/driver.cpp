...
static const char* const k_pch_ForDesktop_SecondsFromVsyncToPhotons_Float = "secondsFromVsyncToPhotons";
static const char* const k_pch_ForDesktop_DisplayFrequency_Float = "displayFrequency";
...
EVRInitError CWatchdogDriver_ForDesktop::Init(vr::IVRDriverContext* pDriverContext)
{
...
class CForDesktopDeviceDriver : public vr::ITrackedDeviceServerDriver, public vr::IVRDisplayComponent
{
    public:
    CForDesktopDeviceDriver()
    {
        ...
        char buf[1024];
        vr::VRSettings()->GetString(k_pch_ForDesktop_Section, k_pch_ForDesktop_SerialNumber_String, buf, sizeof(buf));
        m_sSerialNumber = buf;

        vr::VRSettings()->GetString(k_pch_ForDesktop_Section, k_pch_ForDesktop_ModelNumber_String, buf, sizeof(buf));
        m_sModelNumber = buf;

        m_nWindowX = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_WindowX_Int32);
        m_nWindowY = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_WindowY_Int32);
        m_nWindowWidth = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_WindowWidth_Int32);
        m_nWindowHeight = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_WindowHeight_Int32);
        m_nRenderWidth = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_RenderWidth_Int32);
        m_nRenderHeight = vr::VRSettings()->GetInt32(k_pch_ForDesktop_Section, k_pch_ForDesktop_RenderHeight_Int32);
    ...
    virtual EVRInitError Activate(vr::TrackedDeviceIndex_t unObjectId)
    {
        ...
        if (!bSetupIconUsingExternalResourceFile)
        {
            ...
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceOff_String, "{forDesktop}/icons/headset_sample_status_off.png");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceSearching_String, "{forDesktop}/icons/headset_sample_status_searching.gif");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceSearchingAlert_String, "{forDesktop}/icons/headset_sample_status_searching_alert.gif");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceReady_String, "{forDesktop}/icons/headset_sample_status_ready.png");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceReadyAlert_String, "{forDesktop}/icons/headset_sample_status_ready_alert.png");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceNotReady_String, "{forDesktop}/icons/headset_sample_status_error.png");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceStandby_String, "{forDesktop}/icons/headset_sample_status_standby.png");
            vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_NamedIconPathDeviceAlertLow_String, "{forDesktop}/icons/headset_sample_status_ready_low.png");
        }
